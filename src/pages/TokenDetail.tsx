                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-semibold flex items-center">
                            {tokenDetails.name}
                            <span className="text-token-purple ml-2 text-sm bg-token-purple/20 px-2 py-0.5 rounded-full">
                                TOKEN
                            </span>
                        </h1>
                        <div className="flex items-center text-sm">
                            <span
                                className={`flex items-center ${
                                    tokenDetails.priceChange >= 0 ? 'text-green-500' : 'text-red-500'
                                }`}
                            >
            ...
            <Drawer open={activeDrawer === 'buy'} onOpenChange={(open) => !open && setActiveDrawer(null)}>
                <DrawerContent className="px-4 pb-8">
                    <DrawerHeader>
                        ...
                        <DrawerDescription>Purchase utility tokens to chat with this AI character</DrawerDescription>
                    </DrawerHeader>
                    <div className="space-y-4">
                        <div className="flex p-4 glass rounded-xl items-center">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-sm text-token-purple">
                                    ${tokenDetails.price.toFixed(2)} per token
                                </div>
                            </div>
                        </div>
            ...
            <Drawer open={activeDrawer === 'sell'} onOpenChange={(open) => !open && setActiveDrawer(null)}>
                <DrawerContent className="px-4 pb-8">
                    <DrawerHeader>
                        ...
                        <DrawerDescription>Sell your tokens back to the marketplace</DrawerDescription>
                    </DrawerHeader>
                    <div className="space-y-4">
                        <div className="flex p-4 glass rounded-xl items-center">
                            <img
                        ...
                        <Button className="w-full bg-red-500 hover:bg-red-500/90 h-12">Confirm Sale</Button>
                    </div>
                </DrawerContent>
            </Drawer>
        </div>
