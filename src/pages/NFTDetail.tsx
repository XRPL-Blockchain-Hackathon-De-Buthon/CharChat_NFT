...
const mockNFTDetails = {
    '1': {
        ...
        userCount: 3240,
        description:
            'Creative Helper is an AI chatbot designed to assist with creative tasks like brainstorming, writing, and design concepts. This NFT gives you full IP ownership of the chatbot, including all future earnings from token usage.',
    },
    '2': {
        id: '2',
        ...
        userCount: 4120,
        description:
            "Brainstorm Buddy helps users generate ideas and think creatively. This NFT represents full intellectual property ownership of the chatbot's personality, training data, and future developments.",
    },
    '3': {
        id: '3',
        name: 'Code Ninja IP',
        ...
        userCount: 2870,
        description:
            'Code Ninja is an AI assistant that helps with programming tasks, debugging, and learning to code. Owning this NFT gives you complete IP rights to the Code Ninja chatbot.',
    },
    '4': {
        id: '4',
        ...
        userCount: 2340,
        description:
            "Fitness Coach is an AI chatbot that provides workout plans, nutrition advice, and motivation for fitness enthusiasts. This NFT includes full ownership of the chatbot's IP.",
    },
};
    ...
    return (
        <div className="pb-20 min-h-screen animate-fade-in">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className={`h-10 w-10 flex items-center justify-center rounded-full ${
                            isFavorite ? 'text-red-500 bg-red-500/10' : 'hover:bg-white/10'
                        }`}
                    >
            ...
            <main className="px-4 py-2">
                <NFTDetailCard {...nftDetails} chartData={generateChartData(30, 0.5, 1.5)} />
            </main>
            ...
            <Drawer>
                ...
                <DrawerContent className="px-4 pb-8">
                    <DrawerHeader>
                        ...
                        <DrawerDescription>You're purchasing full IP rights to {nftDetails.name}</DrawerDescription>
                    </DrawerHeader>
                    <div className="space-y-4">
                        <div className="flex p-4 glass rounded-xl">
                            ...
                            <div>
                                ...
                                <div className="text-xl font-bold mt-1">{nftDetails.price} XRP</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="glass p-3 rounded-lg flex items-center">
                                <div className="h-8 w-8 rounded-full bg-white/20 mr-3 flex items-center justify-center">
                                    ...
                                    >
                                        <path
                                            d="M7.99984 1.33337L3.1665 8.00004L7.99984 10.6667L12.8332 8.00004L7.99984 1.33337Z"
                                            fill="white"
                                        />
                                        <path
                                            d="M3.1665 8.88892L7.99984 14.6667L12.8332 8.88892L7.99984 11.5556L3.1665 8.88892Z"
                                            fill="white"
                                        />
                                    </svg>
                                </div>
                        ...
                        <div className="glass p-4 rounded-lg">
                            <div className="flex justify-between text-sm mb-2">
                                ...
                                <span>{nftDetails.price} XRP</span>
                            </div>
                            <div className="flex justify-between text-sm mb-2">
                                <span>Service Fee (2.5%)</span>
                                <span>{(nftDetails.price * 0.025).toFixed(3)} XRP</span>
                            </div>
                            <div className="border-t border-white/10 my-2 pt-2 flex justify-between font-medium">
                                <span>Total</span>
                                <span>{(nftDetails.price * 1.025).toFixed(3)} XRP</span>
                            </div>
                        </div>
            ...
            <Drawer>
                ...
                <DrawerContent className="px-4 pb-8">
                    <DrawerHeader>
                        ...
                        <DrawerDescription>Make an offer for {nftDetails.name}</DrawerDescription>
                    </DrawerHeader>
                    <div className="space-y-4">{/* Offer form here */}</div>
                </DrawerContent>
            </Drawer>
        </div>
    );
