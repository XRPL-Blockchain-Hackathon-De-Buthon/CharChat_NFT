                ...
                <div className="flex border-b border-border">
                    <button
                        className={`flex-1 py-2 text-center text-sm font-medium relative ${
                            activeTab === 'nft' ? 'text-foreground' : 'text-muted-foreground'
                        }`}
                    ...
                    <button
                        className={`flex-1 py-2 text-center text-sm font-medium relative ${
                            activeTab === 'token' ? 'text-foreground' : 'text-muted-foreground'
                        }`}
                    ...
                    <div className="glass p-6 rounded-xl mb-6">
                        ...
                        <div className="flex items-center justify-between mb-3">
                            <div>
                                ...
                                <div className="text-2xl font-bold">13.45 XRP</div>
                            </div>
                            <div>
                                <div className="text-sm text-muted-foreground">Floor Price</div>
                                <div className="text-2xl font-bold">0.65 XRP</div>
                            </div>
                            <div>
                        ...
                        <TokenPriceChart
                            data={generateChartData(10, 0.65, 1.2)}
                            color="#3B82F6"
                            height={120}
                            showGrid
                        />
                                ...
                                <div key={nft.id} className="glass flex overflow-hidden">
                                    ...
                                    <div className="flex-1 p-3 flex flex-col justify-between">
                                        ...
                                        <div className="flex justify-between items-center">
                                            <div className="text-sm font-medium">{nft.price} XRP</div>
                    ...
                    {viewMode === 'grid' ? (
                        ...
                        <div className="space-y-3">
                            {mockTokens.map((token) => (
                                <div
                                    key={token.id}
                                    className="glass flex overflow-hidden bg-gradient-to-r from-purple-900/10 to-transparent"
                                >
                                    <div className="w-24 h-24">
                                        <img
                                            src={token.image}
                                    ...
                                    <div className="flex-1 p-3 flex flex-col justify-between">
                                        ...
                                        <div className="flex justify-between items-center">
                                            <div className="text-sm font-medium text-token-purple">
                                                {token.price} tokens
                                            </div>
